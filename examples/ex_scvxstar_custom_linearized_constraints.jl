"""Continuous CR3BP with user-defined set_linearized_constraints!"""
...
save(joinpath(@__DIR__, "plots/cr3bp_traj_scvxstar_custom_linearized_constraints.png"), fig; px_per_unit=3)
display(fig)
println("Done!")
