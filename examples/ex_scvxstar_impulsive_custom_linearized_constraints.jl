"""Impulsive CR3BP with user-defined set_linearized_constraints!"""
...
println("J0     = $(solution.info[:J0][end])")
...
axu = Axis(fig[1,2], xlabel="Time", ylabel="||ΔV||")
stem!(axu, times, solution.u[4,:], color=:black)

save(joinpath(@__DIR__, "plots/cr3bp_traj_scvxstar_impulsive_custom_linearized_constraints.png"), fig; px_per_unit=3)
display(fig)
println("Done!")
