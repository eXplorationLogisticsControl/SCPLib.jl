"""Test problem with non-convex dynamics only, user-defined set_linearized_constraints!"""
...
function test_scvxstar_custom_linearized_constraints(;verbosity::Int = 0)
    μ = 1.215058560962404e-02
    DU = 389703     # km
    TU = 382981     # sec
    MU = 500.0      # kg
    VU = DU/TU      # km/s
    params = ControlParams_custom_linearized_constraints(μ)
