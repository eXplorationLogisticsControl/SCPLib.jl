...
function evaluate_noncvx_gradient(lincache::AbstractLinearizationCache, ∇noncvx::Function, x_ref, u_ref)
...
function set_g_noncvx_cache!(lincache::AbstractLinearizationCache, ∇g_noncvx::Function, x_ref, u_ref)
    lincache.∇g[:,:] = evaluate_noncvx_gradient(lincache, ∇g_noncvx, x_ref, u_ref)
    return
end
...
function set_h_noncvx_cache!(lincache::AbstractLinearizationCache, ∇h_noncvx::Function, x_ref, u_ref)
    lincache.∇h[:,:] = evaluate_noncvx_gradient(lincache, ∇h_noncvx, x_ref, u_ref)
    return
end
